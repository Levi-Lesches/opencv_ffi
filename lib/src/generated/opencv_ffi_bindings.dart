...
class OpenCVBindings {
  ...
  late final _Mat_createFromPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<Mat> Function(ffi.Int, ffi.Int, ffi.Pointer<ffi.Uint8>)>>(
          'Mat_createFrom');
  late final _Mat_createFrom =
      _Mat_createFromPtr.asFunction<ffi.Pointer<Mat> Function(int, int, ffi.Pointer<ffi.Uint8>)>();
